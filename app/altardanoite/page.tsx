...
export const metadata: Metadata = {
  ...
  description:
    'Entre para a comunidade de oração do Pr. Altomir Rangel. Todos os dias, juntos na presença de Deus.',
  openGraph: {
    title: 'Altar de Oração | Altomir Rangel',
    description: 'Faça parte da comunidade de oração do Pr. Altomir Rangel.',
    type: 'website',
    locale: 'pt_BR',
  },
...
function MarqueeGroup({ hidden = false }: { hidden?: boolean }) {
  return (
    <div aria-hidden={hidden} className="flex shrink-0 items-center whitespace-nowrap py-[7px]">
      {Array.from({ length: 6 }).map((_, i) => (
        <span key={i} className="mx-4 font-bebas text-[12px] tracking-[0.32em] text-[#16243B]">
  ...
  return (
    <main className="relative w-full overflow-hidden">
      ...
      <section className="relative min-h-screen w-full overflow-hidden lg:grid lg:grid-cols-[1fr_1fr] lg:items-stretch">
        ...
        <div
          className="pointer-events-none absolute left-1/2 top-0 z-0 h-[440px] w-[760px] max-w-[155vw] -translate-x-1/2 lg:left-[52%] lg:h-[620px] lg:w-[1100px]"
        ...
        {/* ===== FOTO DESKTOP — grande, centralizada e bem enquadrada ===== */}
        <div className="pointer-events-none z-0 hidden lg:col-start-2 lg:row-start-1 lg:flex lg:items-end lg:justify-start lg:self-end">
          <img
            src="/altomir-recorte.webp"
            alt="Pr. Altomir Rangel"
            className="h-[101vh] w-auto max-w-none -translate-x-[6%] object-contain object-bottom drop-shadow-[0_30px_60px_rgba(0,0,0,0.5)] xl:h-[107vh]"
          />
        </div>
        ...
        />
        {/* fade na base (desktop) — sem corte seco da foto */}
        <div
          className="pointer-events-none absolute inset-x-0 bottom-0 z-0 hidden h-[16vh] lg:block"
          style={{ background: 'linear-gradient(to top, #16243B 0%, rgba(22,36,59,0.55) 42%, transparent 100%)' }}
        />

        {/* ===== MARCA (mobile, sobre a foto) ===== */}
        <div className="absolute top-5 left-1/2 z-20 -translate-x-1/2 lg:hidden">
          <span className="font-bebas text-base tracking-[0.34em] text-white/90">ALTOMIR&nbsp;RANGEL</span>
        </div>
        ...
        <div className="relative z-10 col-start-1 row-start-1 flex min-h-screen flex-col items-center px-6 pt-[44vh] pb-10 text-center sm:pt-[47vh] lg:items-start lg:justify-center lg:pt-0 lg:pb-0 lg:pl-[8%] lg:pr-6 lg:text-left">
          <div className="flex w-full max-w-[480px] flex-col items-center lg:max-w-[620px] lg:items-start">
            {/* marca em fluxo (desktop) */}
            <span className="mb-5 hidden font-bebas text-[14px] tracking-[0.34em] text-white/75 lg:block">
              ALTOMIR&nbsp;RANGEL
            </span>

            <h1 className="font-bebas leading-[0.87] text-white text-[clamp(58px,9vw,116px)] drop-shadow-[0_4px_30px_rgba(8,14,26,0.92)]">
              Altar de<br /><span className="text-[#D8A93A]">Oração</span>
            </h1>

            <p className="font-inter mt-5 max-w-[460px] text-[16px] leading-relaxed text-white/85 drop-shadow-[0_2px_18px_rgba(8,14,26,0.9)] sm:text-[18px]">
              Faça parte da comunidade de oração do Pr. Altomir Rangel. Todos os dias, juntos na presença de Deus — fortalecendo a fé e orando uns pelos outros.
            </p>

            <div className="mt-7 w-full max-w-[500px] text-left">
              <LeadForm />
            </div>
          </div>
        </div>
