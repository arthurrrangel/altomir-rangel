...
const meta: Record<string, { badge?: string; readers: string; badgeColor?: string }> = {
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="flex flex-col gap-8 md:gap-10">
          {books.map((book, idx) => {
            ...
            return (
              <div key={book.slug}
                className={`reveal group relative flex flex-col md:flex-row ${isEven ? '' : 'md:flex-row-reverse'} border border-white/8 hover:border-[#C5973F]/40 bg-[#0F0F17] overflow-hidden transition-all duration-500 hover:shadow-[0_24px_80px_rgba(197,151,63,0.12)]`}>

                <div className="absolute inset-0 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  style={{ background: 'radial-gradient(ellipse at center,rgba(197,151,63,0.04) 0%,transparent 70%)' }} />

                <div className="flex-shrink-0 flex items-center justify-center bg-[#0D0D14] md:w-[280px] py-10 px-8">
                  <div className="relative w-[160px] md:w-[190px]" style={{ aspectRatio: '3/4' }}>
                    <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 w-[80%] h-6 bg-black/60 blur-xl rounded-full" />
                    <div className="relative w-full h-full overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.7)] group-hover:shadow-[0_24px_70px_rgba(197,151,63,0.18)] transition-shadow duration-500"
                    ...
                    {m.badge && (
                      <div className="absolute -top-2 -left-2 z-10">
                        <span className="font-inter text-[8px] font-bold tracking-[0.2em] uppercase px-2 py-1 shadow-lg"
                  ...
                  <div className="border border-white/8 bg-white/[0.02] p-4 md:p-5 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                    ...
                    <div className="flex flex-col gap-2 min-w-[200px]">
                      <a
                        ...
                        className="flex items-center justify-center gap-2 font-inter text-[11px] font-black tracking-[0.18em] uppercase px-6 py-3.5 transition-all duration-200 active:scale-95"
          ...
          <div className="flex flex-col md:flex-row items-center gap-8 p-7 sm:p-10 md:p-12">
            ...
            <div className="flex-1 flex flex-col gap-4 text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-2">
                ...
                <span className="font-inter text-[10px] font-bold tracking-[0.3em] uppercase text-[#C5973F]">Oferta Especial — Combo</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-end gap-5 border border-white/8 bg-white/[0.02] p-4 md:p-5">
                <div className="flex flex-col gap-1">
                  <span className="font-inter text-[12px] text-white/30 line-through">Preço original: R$ 139,98</span>
                  <div className="flex items-baseline gap-3 flex-wrap justify-center md:justify-start">
                    <span className="font-bebas text-[46px] leading-none text-[#C5973F]">R$ 79,99</span>
                    <span className="inline-flex items-center gap-1 bg-green-500/20 text-green-400 font-inter text-[10px] font-bold tracking-[0.15em] uppercase px-2.5 py-1 border border-green-500/30">
                      <Zap size={9} className="fill-green-400" />43% OFF
                    </span>
                  </div>
                  <span className="font-inter text-[11px] text-green-400/80">Você economiza R$ 59,99 em relação ao preço original</span>
                </div>
                <div className="flex flex-col gap-2 min-w-[220px]">
                  <a href="https://wa.me/5521999999999?text=Quero%20o%20combo%20dos%20dois%20livros%20do%20Altomir%20Rangel%20por%20R%24%2079%2C99"
                    target="_blank" rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 bg-[#C5973F] hover:bg-[#d4a84a] active:scale-95 text-black font-inter text-[11px] font-black tracking-[0.18em] uppercase px-6 py-3.5 transition-all duration-200 shadow-[0_8px_30px_rgba(197,151,63,0.30)]">
                    <MessageCircle size={14} />Pedir Combo via WhatsApp
                  </a>
                  <p className="font-inter text-[10px] text-white/25 text-center">Entrega em todo o Brasil · Frete a combinar</p>
                </div>
              </div>
            </div>
          </div>
