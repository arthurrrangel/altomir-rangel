...
const testimonials = [
  {
    ...
    initials: 'CM',
    featured: true,
    text: 'Comecei a assistir numa fase bem pesada e os vídeos foram me ajudando a enxergar as coisas diferente. Não é aquela pregação distante — é Palavra com contexto real, do dia a dia. Virou parte da minha rotina sem eu perceber.',
    videoId: 'PIMWrO-nw0U',
  ...
  },
  {
    ...
    initials: 'RF',
    featured: false,
    text: 'Não sou muito de pregação, mas o Altomir fala de um jeito que prende. Direto, sem rodeio, sem aquela performance. O canal foi crescendo pra mim devagar, até que virou hábito mesmo.',
    videoId: '43-bGX4MfGg',
  ...
  },
  {
    ...
    initials: 'SC',
    featured: false,
    text: 'Assisto o ao vivo quase toda semana e sempre tem algo que fica. Não é conteúdo vazio, dá pra sentir que tem estudo e cuidado por trás. O tema sobre a mente eu voltei pra ouvir mais de uma vez.',
    videoId: 'FVwvjO6AuNo',
  ...
  },
  {
    ...
    initials: 'MA',
    featured: false,
    text: 'O canal chegou até mim por indicação e fui com ceticismo. Mas o conteúdo é sólido, não tem apelo emocional forçado. Fica, porque é verdade mesmo. Já indiquei pra bastante gente.',
    videoId: 'j1rYS5reC54',
