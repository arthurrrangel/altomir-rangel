...
const testimonials = [
  {
    ...
    initials: 'CM',
    featured: true,
    text: 'Estava num momento de seca espiritual quando encontrei o canal. Assisti esse vídeo às 2h da manhã e saí completamente diferente. Não consigo explicar a paz que veio. Hoje é meu devocional todo dia sem falta.',
    videoId: 'PIMWrO-nw0U',
  ...
  },
  {
    ...
    initials: 'SC',
    featured: false,
    text: 'Esse vídeo me fez entender por que eu ficava presa nos mesmos ciclos. Chorei muito, mas foi uma libertação. Mandei para todo mundo da minha célula.',
    videoId: 'FVwvjO6AuNo',
  ...
  },
  {
    ...
    initials: 'AS',
    featured: false,
    text: 'Nunca pensei que ia chorar assistindo um YouTube. A mensagem sobre milagres me pegou de surpresa. Esse vídeo mudou minha relação com Deus de verdade.',
    videoId: 'MoM39WKTCyk',
